...
<h3>Shopping Portal</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Ecommerce platform designed for smart people <br> buy and enjoy <br> </p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">hemanthhemu14319@gmail.com</a></span>
                </div>
            </li>
